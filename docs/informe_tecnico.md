...
Bienvenido a la versión técnica del proyecto. Aquí te contamos, de forma directa y práctica, cómo está armado el intérprete/compilador, qué se agregó en esta fase (ARM64 y arreglos irregulares) y cómo validamos que todo funcione. La idea es que lo puedas leer como una guía técnica.
